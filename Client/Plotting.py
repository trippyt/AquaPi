...
class CustomWidget(pg.GraphicsWindow):
    ...
    def __init__(self, parent=None, **kargs):
        ...
        p1 = self.addPlot(labels={'left': 'Temperature / °C', 'bottom': 'Time / HH:MM'})
        self.data1 = np.random.normal(size=10)
        self.data2 = np.random.normal(size=10)
        self.curve1 = p1.plot(self.data1, pen=(3, 3), symbol='o')
        self.curve2 = p1.plot(self.data2, pen=(2, 3), symbol='o')
